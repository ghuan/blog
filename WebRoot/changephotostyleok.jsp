...
PhotoStyle ss=new PhotoStyle();
ss.setStyleid(styleid);
ss.setStyle(style);
ss.setInputtime(new Timestamp(new Date().getTime()));
gaohu.updatePhotoStyle(ss);
%>
...
<html>
  <head>
    ...
    <title>My JSP 'changephotostyleok.jsp' starting page</title>
  ...
  <body>
      修改成功..
    <%
		response.setHeader("refresh", "0;url=changephotostyle.jsp");
	%>
  </body>
</html>
