...
<%   
	...
	try {
     ...
     int photoid=Integer.parseInt(su.getRequest().getParameter("photoid"));
    ...
    Photo pho=new Photo();
    pho.setPhotoid(photoid);
    pho.setStyleid(styleid);
    pho.setTitle(title);
    pho.setText(text);
    pho.setPhoadd(paths);
    pho.setInputtime(new Timestamp(new Date().getTime()));
    photo.updatePhoto(pho);
 %>
修改成功..
    <%
		response.setHeader("refresh", "0;url=changephoto.jsp");
	%>